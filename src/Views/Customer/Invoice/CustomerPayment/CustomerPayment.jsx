...
import CardPayment from "../../../Admin/Invoice/Payment/CardPayment";
import AchPayment from "../../../Admin/Invoice/Payment/AchPayment";
import { Circles, ColorRing } from "react-loader-spinner";
import { Button } from "reactstrap";
import "../../../Admin/Invoice/style.css";
        ...
        >
          ...
          >
            ...
            <Grid className="d-flex flex-column flex-md-row justify-content-between my-2 gap-2">
              ...
              >
                #{invoiceData?.InvoiceNumber || "Invoice Number not available"}
              </Typography>
            </Grid>
            <Grid className="d-flex flex-column flex-md-row justify-content-between my-2 gap-2">
              <Typography
            ...
            <Grid className="d-flex flex-column flex-md-row justify-content-between my-2 gap-2">
              <Typography
                style={{ color: "#063164", fontWeight: 600, fontSize: "16px" }}
              >
                Total
              </Typography>
              <Typography
