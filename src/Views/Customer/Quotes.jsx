      ...
      >
        ...
        <CardBody>
          ...
          <CardText className="invoice-card-text text-blue-color">
            ...
            {quote?.address?.State}, {quote?.address?.Country}
          </CardText>
        </CardBody>
        ...
        <Grid>
          ...
          <Grid className="invoice-grid">
            {hasQuotes ? (
              Object.keys(quotes).map(
                (status) =>
                  quotes[status].length > 0 && (
                    ...
                    >
                      <Typography
                        className="invoice-status-header mb-3 fw-bolder px-2 quoteStatusCustomker"
                        style={{ width: "31%" }}
                      >
              ...
              <Typography className="no-data-found">No Quotes Found</Typography>
            )}
          </Grid>
        </Grid>
      )}
