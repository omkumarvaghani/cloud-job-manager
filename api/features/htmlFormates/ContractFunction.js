...
const contractPdf = async (data) => {
  let html = fs.readFileSync(
    path.join(process.cwd(), "features", "htmlFormates", "ContractPDF.html"),
    "utf8"
  );
  ...
  //     ? `<span style="color:orange;">Awaiting Response</span>`
  //     : data?.Status === "Today"
  //     ? `<span style="color: #58cc58;">Today</span>`
  //     : data?.Status === "Draft"
  //     ? `<span style="color: rgb(6, 49, 0.2);">Draft</span>`
